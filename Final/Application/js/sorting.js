function ResetTableHeaders() {
    var tableHeaders = [
        ...
        document.getElementById("SortByScore")
    ];
...
function SortByScore() {
    ...
    ResetTableHeaders();
    if (sortOrder == 1) {
        movies.sort(compareScoreDescending);
        document.getElementById("SortByScore").innerText = "Score \u2193";
    } else {
        movies.sort(compareScoreAscending);
        document.getElementById("SortByScore").innerText = "Score \u2191";
    }
}
...
// Function to sort array returned from PHP by Score ascending
...
// Function to sort array returned from PHP by Score descending
